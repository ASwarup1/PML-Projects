...
In 'caret' only mtry parameter is available for tuning. However, for the sake of simplicity we'd leave it as default. One can get higher accuracy by increasing ntree - upto a limit - then it flattens. We chose ntree = 100.
